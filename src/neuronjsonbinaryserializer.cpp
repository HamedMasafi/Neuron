...
NeuronJsonBinarySerializer::NeuronJsonBinarySerializer(QObject *parent) : NeuronAbstractSerializer(parent)
{

}

QByteArray NeuronJsonBinarySerializer::serialize(QVariant v)
{
...
QByteArray NeuronJsonBinarySerializer::serialize(QVariantList list)
{
...
QByteArray NeuronJsonBinarySerializer::serialize(QVariantMap map)
{
...
QVariant NeuronJsonBinarySerializer::deserialize(QByteArray bytes)
{
...
QVariantMap NeuronJsonBinarySerializer::serializeQObject(QObject *obj)
{
    QVariantMap map;
...
void NeuronJsonBinarySerializer::deserializeQObject(QObject *obj, QVariantMap map)
{
    for(int i = 0; i < obj->metaObject()->propertyCount(); i++){
        QMetaProperty property = obj->metaObject()->property(i);
        if(property.isReadable() && property.isWritable())
...
QJsonObject NeuronJsonBinarySerializer::toJson(QVariant v)
{
    switch(v.type()){
    case QVariant::Map:
...
//        if(v.value<QObject*>()->metaObject()->inherits(&NeuronPeer::staticMetaObject))
        if(v.value<QObject*>()->inherits("NeuronPeer"))
            o.insert(VARIANT_TYPE, QString(v.value<NeuronPeer*>()->peerName())+ "*");
        else
...
QJsonObject NeuronJsonBinarySerializer::toJson(QVariantList list)
{
    if(!list.count())
        qWarning("Count = 0");
...
QJsonObject NeuronJsonBinarySerializer::toJson(QStringList list)
{
    QJsonArray array;
    foreach (QVariant v, list) {
        array.append(toJson(v));
...
QJsonObject NeuronJsonBinarySerializer::toJson(QVariantMap map)
{
...
QVariant NeuronJsonBinarySerializer::fromJson(QJsonObject object)
{
...
QVariant NeuronJsonBinarySerializer::fromJson(QJsonArray array)
{
    QVariantList list;
