...
NoronPeer::NoronPeer(QObject *parent)
    : QObject(parent), _peerName(QString::null), m_hub(0)
{
}

NoronPeer::NoronPeer(NoronAbstractHub *hub, QObject *parent)
    : QObject(parent), _peerName(QString::null), m_hub(0)
{
    setHub(hub);
}
...
qlonglong NoronPeer::invokeOnPeer(QString methodName, QVariant val0,
...
void NoronPeer::setHub(NoronAbstractHub *hub)
{
    ...
    if (hub) {
        connect(hub, &NoronAbstractHub::disconnected, this,
                &NoronPeer::hub_disconnected);
